...
Функция СоответствияНазванийВидовОбъектовИнициализировать()
    ...
    СтрокаСоответствия = СоответствияНазванийВидовОбъектов.Добавить();
    СтрокаСоответствия.Группа = "Общие";
    СтрокаСоответствия.ИмяАнгл = "HTTPService";
    СтрокаСоответствия.ИмяАнглМнФормы = "HTTPServices";
    СтрокаСоответствия.Имя = "HTTPСервис";
    СтрокаСоответствия.ИмяМнФормы = "HTTPСервисы";
